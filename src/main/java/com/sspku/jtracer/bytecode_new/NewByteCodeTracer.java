...
public class NewByteCodeTracer {
    public static String nativeFile = "/home/rupesh.punna/SWAT4J/elasticsearch.txt";
    public static String pathPrefix = "/home/rupesh.punna/SWAT4J/target/deps/";
...
//use this for single bytecode
// public static void main(String[] args) throws IOException {
//     if (args.length != 1) {
//         System.err.println("Usage: java NewByteCodeTracer <path/to/SomeClass.class>");
//         return;
//     }

//     String classFilePath = args[0];
//     System.out.println("Analyzing class file: " + classFilePath);

//     byte[] classBytes = Util.getClassBytesFromFile(classFilePath); 
...
//     System.out.println("Count of called native methods: " + Util.visitedNative.size());
// }
//use this for jar files extracted from the mvn repo
...
//        System.out.println(jarPathResult);
    ...
    public void trace(String className) throws IOException {
        // System.out.println("DEBUG: ClassReader loading: " + className);
